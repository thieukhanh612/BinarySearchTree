        ...
        private void btnSaveImage_Click(object sender, EventArgs e)
        {
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                {                        
                    ...
                    g.DrawString("http://yinyangit.wordpress.com", new Font("Arial",12), Brushes.Red, 1, img.Height - 30);
                    //g.DrawString("http://yinyangit.wordpress.com", new Font("Arial", 12), Brushes.White, 0, img.Height - 31);
